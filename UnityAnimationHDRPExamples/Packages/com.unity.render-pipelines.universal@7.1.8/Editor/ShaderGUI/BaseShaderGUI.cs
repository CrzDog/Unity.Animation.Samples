...
namespace UnityEditor
{
    public abstract class BaseShaderGUI : ShaderGUI
    {
        ...
        protected class Styles
        {
            ...
            public static readonly GUIContent vertexSkinning = new GUIContent("Vertex Skinning",
                "Enable GPU skinning in vertex shader.");
        }
        ...
        protected MaterialProperty vertexSkinningProp { get; set; }
        ...
        public virtual void FindProperties(MaterialProperty[] properties)
        {
            ...
            vertexSkinningProp = FindProperty("_VertexSkinning", properties, false);
        }
        ...
        public virtual void DrawAdvancedOptions(Material material)
        {
            ...
            if (vertexSkinningProp != null)
            {
                EditorGUI.BeginChangeCheck();
                EditorGUI.showMixedValue = vertexSkinningProp.hasMixedValue;
                bool useVertexSkinning = EditorGUILayout.Toggle(Styles.vertexSkinning, vertexSkinningProp.floatValue == 1.0f);
                EditorGUI.showMixedValue = false;
                if (EditorGUI.EndChangeCheck())
                {
                    vertexSkinningProp.floatValue = useVertexSkinning ? 1.0f : 0.0f;
                }
            }
        }
